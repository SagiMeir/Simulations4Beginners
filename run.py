...
# simForMetaD = Simulation(dt = 0.833E-15, R= np.array([[0.8,0,0]]) * 1E-10, Nsteps= 1000000, mass = 6.633E-26, kind = ["Ar"], fac = 1E10, xyzname = "simForMetaD_low.xyz", outname = "simForMetaD_low.log", momentname="simForMetaD_p_low.log", forcenamme="simForMetaD_F_low.log", mtype="NVT", ftype="DoubleWell", gamma= 2.226e13, startingStep=120000, withMetaD=True, w=2E-21, sigma=0.5e-12, MetaDfreq=1000)
# simForMetaD.run()

# MetaD 2 Well with Poisson distribution - low MetaD rate
# simForMetaD = Simulation(dt = 0.833E-15, R= np.array([[0.8,0,0]]) * 1E-10, Nsteps= 1000000, mass = 6.633E-26, kind = ["Ar"], fac = 1E10, xyzname = "simForMetaD_lowWithDist.xyz", outname = "simForMetaD_lowWithDist.log", momentname="simForMetaD_p_lowWithDist.log", forcenamme="simForMetaD_F_lowWithDist.log", mtype="NVT", ftype="DoubleWell", gamma= 2.226e13, startingStep=120000, withMetaD=True, w=2E-21, sigma=0.5e-12, MetaDfreq=1000, withPoissonDist=True)
# simForMetaD.run()

# MetaD 2 Well (DEEP) - low MetaD rate
simForMetaD = Simulation(dt = 0.833E-15, R= np.array([[2.5,0,0]]) * 1E-10, Nsteps= 2000000, mass = 6.633E-26, kind = ["Ar"], fac = 1E10, xyzname = "simForMetaD_lowDeep.xyz", outname = "simForMetaD_lowDeep.log", momentname="simForMetaD_p_lowDeep.log", forcenamme="simForMetaD_F_lowDeep.log", mtype="NVT", ftype="DoubleWell", gamma= 2.226e13, startingStep=120000, withMetaD=True, w=2.5E-20, sigma=0.5e-12, MetaDfreq=500, isDeep=True)
simForMetaD.run()

# MetaD 2 Well (DEEP) with Poisson distribution - low MetaD rate
simForMetaD = Simulation(dt = 0.833E-15, R= np.array([[2.5,0,0]]) * 1E-10, Nsteps= 2000000, mass = 6.633E-26, kind = ["Ar"], fac = 1E10, xyzname = "simForMetaD_lowWithDistDeep.xyz", outname = "simForMetaD_lowWithDistDeep.log", momentname="simForMetaD_p_lowWithDistDeep.log", forcenamme="simForMetaD_F_lowWithDistDeep.log", mtype="NVT", ftype="DoubleWell", gamma= 2.226e13, startingStep=120000, withMetaD=True, w=2.5E-20, sigma=0.5e-12, MetaDfreq=500, withPoissonDist=True, isDeep=True)
simForMetaD.run()
