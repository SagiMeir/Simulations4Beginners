...
# MetaD 2 Well
simForMetaD = Simulation(dt = 0.833E-15, R= np.array([[0.8,0,0]]) * 1E-10, Nsteps= 1000000, mass = 6.633E-26, kind = ["Ar"], fac = 1E10, xyzname = "simForMetaD.xyz", outname = "simForMetaD.log", momentname= "simForMetaD_p.log", mtype="NVT", ftype="DoubleWell", gamma= 7.596E13, startingStep=120000, withMetaD=True)
simForMetaD.run()   
